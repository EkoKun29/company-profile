            ...
            <div class="container py-5">
                <div class="row g-5">
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <p class="mb-2" style="font-size: 14px;"><i class="fa fa-envelope me-3"></i>arindoutamaperkasa@gmail.com</p>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <h5 class="text-white mb-4">SOSMED</h5>
                        <div class="d-flex pt-2">
                            ...
                            <a class="btn btn-outline-light btn-social" href="mailto:arindoutamaperkasa@gmail.com"><i class="fa fa-envelope"></i></a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="copyright">
                    <div class="row">
                        <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                            Hak Cipta &copy; 2024 <a>PT. ARINDO UTAMA PERKASA</a> 
                        </div>
                    </div>
                </div>
            </div>
